export const TIERS = [
  null,
  { tier: 1,  name: '우주먼지',  radius: 14, color: '#dfe9ff', accent: '#7aa4ff', glow: 0.15, density: 0.0012 },
  ...
  { tier: 9,  name: '적색거성',  radius: 80, color: '#ff5e3a', accent: '#8e1a0f', glow: 1.8,  density: 0.0032, gravity: 0.090,  gravityRadius: 280, pulse: true },
  { tier: 10, name: '초신성',    radius: 92, color: '#ffffff', accent: '#ffe25a', glow: 2.5,  density: 0.0036, gravity: 0.130,  gravityRadius: 320, supernova: true },
  { tier: 11, name: '블랙홀',    radius: 70, color: '#02020a', accent: '#7f4dff', glow: 3.0,  density: 0.010,                                       blackhole: true }
];
